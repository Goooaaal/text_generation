...
tf.flags.DEFINE_string('converter_path', 'model/text-5-3/converter.pkl', 'model/name/converter.pkl')
tf.flags.DEFINE_string('checkpoint_path', 'model/text-5-3', 'checkpoint path')
